...
class AprendizCursoInline(admin.TabularInline):
    ...
    readonly_fields = ['fecha_inscripción']
...
class InstructorCursoAdmin(admin.ModelAdmin):
    list_display = ['instructor', 'curso', 'rol', 'fecha_asignación']
    list_filter = ['rol', 'fecha_asignación']
    search_fields = [
        'instructor__nombre',
...
class AprendizCursoAdmin(admin.ModelAdmin):
    ...
    list_filter = ['estado', 'fecha_inscripción']
    search_fields = [
        'aprendiz__nombre',
        'aprendiz__apellido',
